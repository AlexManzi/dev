...
export const blogPosts = [
  {
    "slug": "when-the-api-says-no-open-a-browser",
    "title": "When the API Says No, Open a Browser",
    "excerpt": "Sometimes the data you need lives in a service you don't control, behind an API you can't get a key for. A headless browser can bridge that gap — but the interesting engineering isn't fetching the data. It's deciding when not to trust it.",
    "date": "2026-08-17",
    "category": "Notes",
